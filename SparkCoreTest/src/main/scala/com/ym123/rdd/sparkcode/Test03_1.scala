...
object Test03_1 {
  def main(args: Array[String]): Unit = {
    ...
    //将所需信息解析出来
    val flatMapRDD: RDD[CategoryCountInfo] = actionRDD.flatMap {
    ...
    //排序 取top10
    mapRDD.sortBy(datas=>(datas.clickCount,datas.orderCount,datas.payCount)).take(10).foreach(println)
